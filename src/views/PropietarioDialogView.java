...
public class PropietarioDialogView extends javax.swing.JDialog {
        ...
        private void obtenerDatosPropietarios() {
                ...
                if (propietario.getPersona() != null) {
                        ...
                        selectCalificacionInquilino
                                        .setSelectedItem(propietario.getPersona().getCalificacionInquilino());

                        selectCalificacionPropietario.setEnabled(true);
                        selectCalificacionPropietario
                                        .setSelectedItem(propietario.getPersona().getCalificacionPropietario());
        ...
        private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnGuardarActionPerformed
                if (validar() && propietario != null) {
                        if (propietario.getId() != null) {

                                // Actualizamos el empleado y la persona
                                int result = JOptionPane.showConfirmDialog(null,
                                                "Esta seguro que desea editar el propietario: ", "Editar propietario",
                                                JOptionPane.YES_NO_OPTION);
                                if (result == 0) {
                                        propietarioData.editarPropietario(propietario);
                                }
                        } else {
                                int result = JOptionPane.showConfirmDialog(null,
                                                "Esta seguro que desea agregar el propietario: ", "Agregar propietario",
                                                JOptionPane.YES_NO_OPTION);
                                if (result == 0) {
                                        if (propietarioData.agregarPropietario(propietario)) {
                                                dispose();
                                        }
                                }
                        }
        ...
        private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnBorrarActionPerformed
                if (propietario.getId() != null) {
                        int result = JOptionPane.showConfirmDialog(null,
                                        "Si elimina el propietario tambien eliminara sus PROPIEDADES\n",
                                        "Esta seguro de eliminar el propietario y sus propiedades",
                                        JOptionPane.YES_NO_OPTION);
                        if (result == 0) {
                                if (propietarioData.eliminarPropietario(propietario.getId())) {
                                        JOptionPane.showMessageDialog(null, "Propieratio Eliminaro exitosamente");
                                        propietario = new Propietario();
        ...
        public static void main(String args[]) {
                ...
                java.awt.EventQueue.invokeLater(new Runnable() {
                        public void run() {
                                PropietarioDialogView dialog = new PropietarioDialogView(new javax.swing.JFrame(),
                                                true);
